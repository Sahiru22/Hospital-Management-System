		...
		<div class="container">
			<div
				...
				<ul
					...
					<li><a href="#" class="nav-link px-2 text-secondary">Admin Dashboard</a></li>
...
<div id="mmenu_screen" class="container-fluid main_container d-flex">
  ...
  <div class="container">
    <p class="mb-1">This is an Online Hospital Management System created by SLIIT students.</p>
    <p class="mb-0">Owner : IT21198922 </p>
  </div>
</footer>
