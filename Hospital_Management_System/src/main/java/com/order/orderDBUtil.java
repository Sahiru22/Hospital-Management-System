...
public class orderDBUtil {
	...
	public static boolean addOrder(String pid, String phone, String name, String address, String mid) {
        ...
        try {
            ...
            String sql = "INSERT INTO hospital.order (idpatient, phone, name, address, idmedicine) VALUES (?, ?, ?, ?, ?)";
...
public static boolean UpdateOrder(String oid, String pid, String phone,String name,String address,String mid){
	...
	try {
		...
		String sql = "update hospital.order set idpatient = '"+pid+"',phone = '"+phone+"', name= '"+name+"', address= '"+address+"', idmedicine  = '"+mid+"' where idorder = '"+oid+"'";
...
public static boolean DeleteOrder(String id) {
	...
	try {
		...
		String sql = "Delete from hospital.order where idorder = '"+convertedID+"'"; 
